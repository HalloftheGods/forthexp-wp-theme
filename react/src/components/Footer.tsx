    ...
    <footer className="border-t border-white/10 bg-slate-950/20 py-16 px-6" id="footer-section">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 text-left items-start">
        ...
        <div className="md:col-span-4 space-y-3">
          <span className="text-[10px] font-mono text-slate-500 uppercase tracking-widest font-semibold block">CMS Integration specs</span>
          ...
          <div className="flex flex-wrap gap-1.5 pt-1.5">
            <span className="text-[9px] font-mono bg-white/5 border border-white/10 text-slate-400 px-2 py-0.5 rounded">WordPress v7.0+</span>
            <span className="text-[9px] font-mono bg-white/5 border border-white/10 text-slate-400 px-2 py-0.5 rounded">Classic & Block Themes</span>
            <span className="text-[9px] font-mono bg-white/5 border border-white/10 text-slate-400 px-2 py-0.5 rounded">REST API v2</span>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-[10px] font-mono text-slate-600">
          © {new Date().getFullYear()} ForTheXP.com. Built as a fully integrated WordPress gamification showcase. All rights reserved.
        </p>
